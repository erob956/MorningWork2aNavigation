...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        var landingViewController = LandingViewController(nibName : "LandingViewController" , bundle : nil)
        
        var loggedInViewController = LoggedInViewController(nibName: "LoggedInViewController" , bundle : nil)
